            ...
            <li  class="has-sub" >
                  ...
                  <ul  class="collapse"  id="promotion"
                    ...
                    <div class="sub-menu">                        
                          ...
                          <li >
                            <a class="sidenav-item-link" href="aficher.php">
      ...
      <div class="page-wrapper">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb p-0">
            ...
            <li class="breadcrumb-item" aria-current="page">Afficher Promotions</li>
          </ol>
        </nav>
...
<table border="1" align="center"  width="100%"   >
  <tbody align="center">
	<tr>
		...
		<td><h1 align="center">Deals</h1></td>
		<td><h1 align="center">start Date</h1></td>
		<td><h1 align="center">end Date </h1></td>
...
<?php
    ...
    ?>
        ...
        <button type="submit" name="supprimer" value="supprimer" class="mb-1 btn btn-outline-danger">
                 Delete </button></td>

              
					<input type="hidden" value="<?PHP echo $row['idpromotion']; ?>" name="idpromotion">
				</form>
			</td>
			<td> <a href ="modifierpromo.php?idpromotion=<?php  echo $row['idpromotion']?>"><h3 align="center"> Modify </h3> </a></td>
