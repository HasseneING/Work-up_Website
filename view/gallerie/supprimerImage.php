              ...
              <ul class="nav sidebar-inner" id="sidebar-menu">
                  ...
                  <li  class="has-sub" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#Services"
                      ...
                      <span class="nav-text">gestion de gallerie</span> <b class="caret"></b>
                    </a>
                    <ul  class="collapse"  id="Services"
                      ...
                      <div class="sub-menu">
                            ...
                            <li >
                              <a class="sidenav-item-link" href="ajouterImage.php">
                                <span class="nav-text">ajouter images</span>
                              </a>
                            </li>
                                      
                            <li >
                              <a class="sidenav-item-link" href="supprimerImage.php">
                                <span class="nav-text">Modifier image</span>
                              </a>
                            </li>

                            <li >
                              <a class="sidenav-item-link" href="supprimerImage.php">
                                <span class="nav-text">supprimer image</span>
                              </a>
                            </li>
...
$list=$gallerie1C->afficherGallerie();
                 ...
                 ?>
                  <div class="card card-table-border-none" id="promotion">
                    ...
                    <div class="card-body pt-0 pb-5">
                      <table  border="1"  class="table card-table table-responsive table-responsive-large" style="width:100%">
                        <thead>
                          <tr>
                        ...
                        ?>
                          ...
                          <tr>
                            ...
                            <td ><center><img src="uploads/images/<?php echo $row['file_name']; ?>" alt="">  </center></td>
                            <td align="center"><center> <?PHP echo $row['title']; ?> </center></td>
                            <td><center><?php echo $row['created']; ?> </center> </td>

                            
                            <form method="POST" action="supprimerImageS.php">
                              <td>
                                <center> 
                                <button type="submit" name="delete" class="mb-1 btn btn-pill btn-danger" value="delete">Delete</button>
            ...
            <td>  <center> </form>
              ...
              <a href="modifierImageS.php?id=<?php echo $row['id'];?>"><button  type="submit" name="modifier" class="mb-1 btn btn-pill btn-danger" value="modiferr"> modifer</button></a> </center></td>
                      ...
                      <center> 
                                <a href="mail.php"><button type="submit" name="ENVOYER" class="mb-1 btn btn-pill btn-danger" value="Envoyer les email">Envoyer les email</button></a>
