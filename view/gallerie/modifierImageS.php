...
$result=$gallerie1C->recupererGallerie($_GET['id']);
foreach($result as $row){
    $title=$row['title'];
    $imagee=$row['file_name'];
}
if (isset($_GET['id'])&&isset($_POST['modifier']))
{
  ...
  $gallerie1C->modifierGalLerie($image,$_POST['title'],$datetime,$_GET['id']);
...
<body class="header-fixed sidebar-fixed sidebar-dark header-light" id="body">
    ...
    <div class="wrapper">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="collapse" id="Services" data-parent="#sidebar-menu">
                                <div class="sub-menu">
                                    ...
                                    <li>
                                        <a class="sidenav-item-link" href="gallerie/ajouterImage.php">
                                            <span class="nav-text">Add image</span>
                                        </a>
                                    </li>

                                    <li>
                                        <a class="sidenav-item-link" href="gallerie/modifierImage.php">
                                            <span class="nav-text">Modify Image</span>
                                        </a>
                                    </li>

                                    <li>
                                        <a class="sidenav-item-link" href="gallerie/supprimerImage.php">
                                            <span class="nav-text">Delete Image</span>
                                        </a>
                                    </li>
        ...
        <div class="page-wrapper">
            ...
            <h3>Modfier une Image </h3>
<form method="POST"  enctype="multipart/form-data">
<div>
    <label class="control-label">Title</label>
    <div class="controls">
    <input class="controle" type="text" name="title" placeholder="Entrer un titre" value="<?php echo $title;?>">
    </div>
    <p>
</div>
  <div>
    <div class="controls">
      ...
      <input name="image" type="file" value="<?php echo $imagee;?>" >
    </div>
