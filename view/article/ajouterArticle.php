                  ...
                  <li  class="has-sub" >
                    ...
                    <ul  class="collapse"  id="Services"
                      ...
                      <div class="sub-menu">
                            ...
                            <li >
                              <a class="sidenav-item-link" href="ajouterArticle.php">
                                <span class="nav-text">Add article</span>
                              </a>
                            </li>
                                      
                            <li >
                              <a class="sidenav-item-link" href="modifierArticle.php">
                                <span class="nav-text">Modify article</span>
                              </a>
                            </li>

                            <li >
                              <a class="sidenav-item-link" href="supprimerArticle.php">
                                <span class="nav-text">Delete article</span>
                              </a>
                            </li>
...
<div>
    ...
    <div class="controls">
    <input class="controle" type="text" name="title" placeholder="Entrer un titre">
    </div>
    <p>
</div>
  <div>
    ...
    <div class="controls">
    <input class="controle" type="text" name="content" placeholder="Entrer un titre">
    </div>
    <p>
  </div>
  <div>
    ...
    <div class="controls">
    <input class="controle" type="text" name="user" placeholder="Entrer un titre">
    </div>
    <p>
  </div>
